...
commands_2 = ["./receiver_cli -q ~/Desktop/APSI/build/query.csv -t 1 -o ~/Desktop/APSI/build/test.csv","./sender_cli -d ~/Desktop/APSI/build/db.csv -p ~/Desktop/APSI/parameters/1M-256.json -c -t 1 "]
commands_3 = "cd ~/Desktop/MPSU/build/ && "
commands_4 = "cd ~/Desktop/APSI/build/bin/ && "
